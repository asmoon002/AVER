...
import os
import sys
anno_path = "../data/Affwild2/annotations/"
...
def produce_anno_csvs(videos, flag):
	save_path = "../data/Affwild2/annotations/preprocessed_VA_annotations/" + flag
...
def produce_total_csvs(flag):
	path = "../data/Affwild2/annotations/preprocessed_all_labeled_images/" + flag
...
def produce_category_csvs():
	path = "../data/Affwild2/annotations/VA_Estimation_Challenge/Train_Set"
	csv_data_list = os.listdir(path)
	VA_spec_data = []
	multi_data = []
	for csv in csv_data_list:
